...
#define DFLT_FONT_SIZE 13.0
#define MIN_FONT_SIZE 12.0
#define MAX_FONT_SIZE 40.0

#define DFLT_PIXEL_SNAP SDL_TRUE
...
#define DFLT_RUN_THUMB_THREAD ON_THUMB_MODE
...
#define DFLT_WARN_TEXT_COPY SDL_TRUE

#define DFLT_FULLSCREEN_GUI DELAY

#define DFLT_BAD_IMGS_BEHAVIOR ALWAYS_ASK
