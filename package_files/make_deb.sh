...
# Build the deb
# fakeroot dpkg-deb -b -Zgzip $PKGDIR sdl-img_1.0.0-beta_amd64.deb
fakeroot dpkg-deb -b $PKGDIR sdl-img_1.0.0-beta_amd64.deb
# alternatively
# dpkg-deb --root-owner-group -b $PKGDIR sdl-img_1.0.0-beta_amd64.deb
